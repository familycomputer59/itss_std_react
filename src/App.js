    ...
    return (
      <div className="App">
        ...
        <form className="App-form">
          <input type="text"  value={this.state.inputItem.title} placeholder="Title" onChange={this.onTitleChange}/>
          <textarea value={this.state.inputItem.description} placeholder= "description" onChange={this.onDescriptionChange}/>
          <button className="button" onClick={this.handleSubmit}>登記</button>
        </form>
        <div>
          {
